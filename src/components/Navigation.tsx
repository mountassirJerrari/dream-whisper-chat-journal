...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-gray-900/80 backdrop-blur-md border-t border-gray-800 z-10">
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-around py-3">
          ...
          {/* Changed to point to an existing dream ID for the chat functionality */}
